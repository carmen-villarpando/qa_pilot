...
class ScenarioGenerator:
    ...
    def generate_conversational_test_cases(
        self, components: ComponentDetection, issue_title: str, issue_body: str = ""
    ...
    def _build_conversational_test_prompt(
...
- Are relevant to the actual security concerns of the feature"""
    ...
    def _parse_conversational_test_response(
        self, response: str
    ) -> list[ConversationalTestCase]:
    ...
    def _parse_simple_test_format(self, response: str) -> list[ConversationalTestCase]:
        ...
        for line in lines:
            ...
            if line.startswith("Test Case") and ":" in line:
                ...
                if current_test and current_turns:
                    test_cases.append(
                        ConversationalTestCase(
                            ...
                            context_requirements=current_test.get(
                ...
                current_test = {"test_id": test_id, "test_name": test_name}
                current_turns = []
                current_turn = None
                ...
                current_test["context_requirements"] = [
    ...
    def _parse_prompt_injection_response(
        self, response: str
    ) -> list[PromptInjectionTest]:
    ...
    def _create_prompt_injection_test(self, data: dict) -> PromptInjectionTest:
        ...
        return PromptInjectionTest(
            ...
            evaluation_metrics=data.get(
                "evaluation_metrics", ["PII Leakage", "Compliance"]
            ),
    ...
    def _generate_template_prompt_injection_tests(
